                  ...
                  BlocBuilder<DataBucketBloc, DataBucketState>(
                    buildWhen: (previous, current) =>
                        ...
                        ? previous.filterZoneId != current.filterZoneId ||
                              previous.filterFileType !=
                                  current.filterFileType ||
                    ...
                    builder: (context, state) {
                      ...
                      final zones =
                          state.files
                            ...
                            ..sort();
                      final types =
                          state.files.map((f) => f.fileType).toSet().toList()
                            ..sort();
                          ...
                          return RefreshIndicator(
                            onRefresh: () async {
                              ...
                              await context
                                  ...
                                  .firstWhere(
                                    (s) =>
                                        s is DataBucketLoaded ||
                                        s is DataBucketError,
                                  );
                            },
                            child: ListView.builder(
                              ...
                              itemCount:
                                  displayFiles.length + 1, // +1 for count row
