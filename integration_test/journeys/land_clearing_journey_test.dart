...
void main() {
  ...
  group('Land Clearing Journey (STEP-45.5)', () {
    testWidgets(
      'login, create land clearing, verify tabs/units/combobox, and save',
      (tester) async {
        ...
        final planAreaField = find.descendant(
          of: find.widgetWithText(Expanded, 'Luas Rencana (Plan)'),
        ...
        final actualAreaField = find.descendant(
          of: find.widgetWithText(Expanded, 'Luas Aktual (Actual)'),
          matching: find.byType(EditableText),
        );
