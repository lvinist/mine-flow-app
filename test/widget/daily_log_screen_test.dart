...
void main() {
  ...
  setUp(() {
    ...
    when(() => mockRepository.getDraftLogForForeman(
          foremanId: any(named: 'foremanId'),
          date: any(named: 'date'),
          siteId: any(named: 'siteId'),
    ...
    when(() => mockRepository.deleteDailyLog(any())).thenAnswer((_) async => {});
  });
  ...
  group('DailyLogFormScreen Widget Tests', () {
    testWidgets('should render all form fields, weather selector, and auto save indicator', (tester) async {
    ...
    testWidgets('should show validation error when submitting with empty summary', (tester) async {
    ...
    testWidgets('should call submitDailyLog when form is valid and submit button pressed', (tester) async {
      await tester.pumpWidget(buildFormScreenWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('should select weather chip and trigger auto-save', (tester) async {
      await tester.pumpWidget(buildFormScreenWidget());
      await tester.pumpAndSettle();
      ...
      verify(() => mockRepository.autoSaveDraft(any())).called(greaterThanOrEqualTo(1));
    });
  });

  group('DailyLogListScreen Widget Tests', () {
    testWidgets('should render list screen title, filter chips, and daily log cards', (tester) async {
    ...
    testWidgets('should filter logs list when status filter chip is clicked', (tester) async {
      await tester.pumpWidget(buildListScreenWidget());
      await tester.pumpAndSettle();
      ...
      verify(() => mockRepository.getDailyLogs(
            date: any(named: 'date'),
            siteId: tSiteId,
            foremanId: tForemanId,
            status: LogStatus.draft,
